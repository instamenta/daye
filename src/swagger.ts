...
const getRemainingMaterialsProperties = (): Record<string, { type: 'number' }> => {
    return Object.fromEntries(
        Object.values(E_TamponMaterials).map((material) => [material, {type: 'number'}])
    );
}
                            ...
                            'application/json': {
                                schema: {
                                    ...
                                    properties: {
                                        type: {
                                            type: 'string',
                                            enum: Object.values(E_SpecificationTypes),
                                        },
                                        quantity: {
                                            type: 'integer',
                                            minimum: 1,
                                                    ...
                                                    { type: 'string' },
                                                    {
                                                        ...
                                                        items: {
                                                            ...
                                                            properties: {
                                                                material: {
                                                                    type: 'string',
                                                                    enum: Object.values(E_TamponMaterials),
                                                                },
                                    ...
                                    examples: {
                                        invalidType: {
                                            value: {
                                                ...
                                                details: `Accepted tampon types: ${Object.values(E_SpecificationTypes).join(', ')}`
                                            }
                                        },
                                        invalidQuantity: {
                                            value: {
